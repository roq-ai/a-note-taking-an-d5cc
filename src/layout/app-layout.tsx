...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Diagram', path: '/diagrams', entity: 'diagram', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Flashcard', path: '/flashcards', entity: 'flashcard', service: AccessServiceEnum.PROJECT, icon: FiBox },
